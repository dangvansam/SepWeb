...
parser.add_argument('--input_csv', type=str, required=True, default="data_tt.csv")
parser.add_argument('--output_csv', type=str, required=True, default="data_tt_noise.csv")
parser.add_argument('--data_type', type=str, required=True, default="tr,vd,tt")
parser.add_argument('--noise_folder', type=str, required=True, default="noise")
parser.add_argument('--output_mix_noise_folder', type=str, required=True, default="wav16k_{tr,vd,tt}_noise")
